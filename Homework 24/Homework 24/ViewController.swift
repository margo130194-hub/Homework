...
final class ViewController: UIViewController {
    ...
    private func setupSubviews() {
        ...
        button.titleLabel?.font = .italicSystemFont(ofSize: 25)
        ...
        button.addTarget(self, action: #selector(currentTime), for: .touchUpInside)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            collectionView.topAnchor.constraint(equalTo: button.bottomAnchor, constant: 20),
    ...
    @objc private func currentTime(){
        let vc = CurrentTimeViewController()
